			...
			stage("Init Pipeline") {
				steps {
					script {
						...
						config.cdConfig.ocpDevDeployment.templates.add(TemplateUtils.getSpringAppDC())
						...
						config.cdConfig.ocpTestDeployment.templates.add(TemplateUtils.getSpringAppDC())
						...
						config.cdConfig.ocpProdDeployment.templates.add(TemplateUtils.getSpringAppDC())
