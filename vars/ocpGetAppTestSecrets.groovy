...
def call(PipelineConfig config, OcpDeployment ocpDeployment) {
    ...
    Map genericSecrets = ocpGetSecretAsMap(ocpDeployment.project, "application-testing")
    Map appSpecificSecrets = ocpGetSecretAsMap(ocpDeployment.project, config.app.id + "-testing")
